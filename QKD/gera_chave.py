...
Qual vai ser a opção:  ''')
    ...
    elif escolher.lower() in ['similaridade', 's', '3']:
        tm.sleep(5)
        porcentagem = porcentagem_diferenca(chave_alice, chave_bob)
        print()
        print(
    ...
    elif escolher.lower() in ['tudo', "t", "4"]:
        tm.sleep(5)
        print()
        print("A chave de Alice: {}".format(chave_alice))
        print("A chave de Bob:   {}".format(chave_bob))
    ...
    elif escolher.lower() in ['Rodar novamente', 'RN', '5']:
        def main():
    ## Roda o codigo novamente
...
Qual vai ser a opção:  ''')
                    ...
                    if escolher.lower() in ['chaves', 'chave', 'c', '1']:
                        ...
                        # Roda de novo gerando novas chaves
                        break  # vai fazer ou pelo menos tentar sair do loop e gerar novas chaves
    ...
    continuar = input("Tem certeza que não quer rodar ? (s/n): ")
    if continuar.lower() != 's':  # Se a expressão for diferente de s, o programa é encerrado
        print("Finalizando o programa. 🙃")
        tm.sleep(5)
        break